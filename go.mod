...
require (
	...
	github.com/whosonfirst/go-whosonfirst-spatial-www v0.7.5
...
require (
	...
	github.com/aaronland/go-http/v4 v4.0.2 // indirect
	...
	github.com/whosonfirst/go-whosonfirst-export/v3 v3.3.0 // indirect
