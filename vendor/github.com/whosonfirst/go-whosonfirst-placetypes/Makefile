...
cli:
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/wof-placetype-ancestors cmd/wof-placetype-ancestors/main.go
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/wof-placetype-children cmd/wof-placetype-children/main.go
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/wof-placetype-descendants cmd/wof-placetype-descendants/main.go
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/wof-placetypes cmd/wof-placetypes/main.go
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/wof-valid-placetype cmd/wof-valid-placetype/main.go
